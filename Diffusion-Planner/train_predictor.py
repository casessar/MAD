...
def get_args():
    ...
    # Truncated Diffusion
    parser.add_argument('--t_start', type=float, help='diffusion truncation upper bound (default: 1.0, no truncation)', default=1.0)
    parser.add_argument('--anchor_npz_path', type=str, help='path to anchor .npz file for ego xT initialization', default=None)
...
def model_training(args):
    ...
    if args.ddp:
        ...
        diffusion_planner = DDP(
            ...
            find_unused_parameters=True  # <--- 加上这一句！
        )
